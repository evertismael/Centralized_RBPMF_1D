classdef Mobile_1D
   ...
   methods
      function obj = Mobile_1D(x0)
          obj.x0 = x0;
          obj.moves_inter = double.empty(2, 0);
          obj.moves_law = repmat(Law_1D(0,0),1,0);
      end
      ...
      function obj = gen_trayectory(obj,dt)
          ...
          obj.history = zeros(2,size(obj.t_vect,2));
          ...
          for law_idx = 1:size(obj.moves_inter,2)
             ...
             if law_idx == 1
                 ...
                 x_init = [1,0]*obj.history(:,t_idx_init-1);
                 v_init = [0,1]*obj.history(:,t_idx_init-1);
             end
             syms tf
             ...
             obj.history(:,t_idxs)=[x_val;vx_val];
          end 
      end
   end
end